...
export const createPortfolio = async ({
  ...
  return await axios
    .post(
      `https://naoyanakamori.com/api/v1/portfolios`,
...
export const getPortfolios = async () => {
    return await axios
      .get(`https://naoyanakamori.com/api/v1/portfolios`,
        {
          headers: {
            "Content-Type": "application/json",
          }
  ...
  export const getPortfolio = async (id) => {
    ...
    return await axios
      .get(`https://naoyanakamori.com/api/v1/portfolios/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
          }
  ...
  export const getMyPortfolios = async (user_id) => {
    return await axios
    .post(`https://naoyanakamori.com/api/v1/portfolios/my_portfolios`,
    {user_id: user_id},
        {
          headers: {
            "Content-Type": "application/json",
