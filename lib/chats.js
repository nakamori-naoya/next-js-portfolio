...
export const getChats = async (portfolio_id) => {
    return await axios
      .get(`${process.env.NEXT_PUBLIC_ENDPOINT_URL}/api/v1/portfolios/${portfolio_id}/chats`,
        {
          headers: {
...
export const createChat = async ({text, user_id, portfolio_id}) =>{
    ...
    return await axios
      .post(
        `${process.env.NEXT_PUBLIC_ENDPOINT_URL}/api/v1/portfolios/${portfolio_id}/chats`,
